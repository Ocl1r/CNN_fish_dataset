...
def pipeline_coreml(model, im, file, names, y, prefix=colorstr('CoreML Pipeline:')):
    ...
    # Checks
    nx, ny = spec.description.cam_input[0].type.imageType.width, spec.description.cam_input[0].type.imageType.height
    na, nc = out0_shape
    ...
    for i in range(2):
        ...
        nms_spec.description.cam_input.add()
        nms_spec.description.cam_input[i].ParseFromString(decoder_output)
    ...
    # Correct datatypes
    pipeline.spec.description.cam_input[0].ParseFromString(model._spec.description.cam_input[0].SerializeToString())
